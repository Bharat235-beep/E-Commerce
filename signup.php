...
<link rel="stylesheet" href="style.css">
  ...
  <body>
    ...
    <form action="signup.php" method="post">
        <fieldset><legend><h1>Sign in</h1></legend>  
...
$sql="Select * from ecommerce where name='$user'";
$result=mysqli_query($conn,$sql);
$num=mysqli_num_rows($result);
if($num>0){
  echo "<script>
  alert('Please try different username');
  </script";
}
else{
  $sql="insert into ecommerce (name,pass) values('$user','$password')";
